...
public class RegistrationService {
    ...
    public StatusResponse registration(UserRegistrationRequest request) {
        if (userRepository.findByUsername(request.getUsername()) != null) {
            return new StatusResponse("Username is already taken");
        }
        ...
        return new StatusResponse("Registration successful");
    }
}
